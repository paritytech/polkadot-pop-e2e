...
six relay validators and four parachain collators. It prepares for Coinage load
...
**1,000,000 ms (1,000 seconds)**, a severe disruption test, not normal WAN latency.

1. Start the engine's snapshot topology and wait for all chains to finalise.
...
The delayed window is shorter than 1,000 seconds. It tests interruption and recovery,
not delivery after a full 1,000-second wait. Removing netem discards queued packets;
...
are omitted. The snapshot's six relay authorities are kept intact.
